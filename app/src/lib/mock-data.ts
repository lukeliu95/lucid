...
const videoSeeds: VideoSeed[] = [
  ...
  { slug: "karpathy-agent-architecture", title_zh: "Andrej Karpathy 讲清楚 Agent 架构", title_en: "Andrej Karpathy on Agent Architecture",
    person_slug: "andrej-karpathy", duration_sec: 4320, topic_slugs: ["ai-agent"], platform: "youtube", platform_id: "kp001" },
  { slug: "jensen-chip-next-decade", title_zh: "Jensen Huang 谈芯片下一个十年", title_en: "Jensen Huang on the next decade of chips",
    person_slug: "jensen-huang", duration_sec: 2280, topic_slugs: ["chip"], platform: "youtube", platform_id: "jh001" },
  { slug: "pg-zero-to-one", title_zh: "Paul Graham:0→1 创业心法", title_en: "Paul Graham: The 0→1 mentality",
    person_slug: "paul-graham", duration_sec: 3120, topic_slugs: ["startup"], platform: "youtube", platform_id: "pg001" },
  { slug: "sam-next-18-months", title_zh: "Sam Altman:接下来 18 个月", title_en: "Sam Altman on the next 18 months",
    person_slug: "sam-altman", duration_sec: 3900, topic_slugs: ["ai"], platform: "youtube", platform_id: "sa001" },
  { slug: "naval-leverage-compounding", title_zh: "Naval:杠杆与判断力的复利", title_en: "Naval: Leverage and the compounding of judgement",
    person_slug: "naval-ravikant", duration_sec: 1680, topic_slugs: ["startup"], platform: "youtube", platform_id: "nv001" },
  { slug: "demis-alphafold-beyond", title_zh: "Demis Hassabis 谈 AlphaFold 之后", title_en: "Demis Hassabis on AlphaFold & beyond",
    person_slug: "demis-hassabis", duration_sec: 4920, topic_slugs: ["ai"], platform: "youtube", platform_id: "dh001" },
  { slug: "future-of-work-amplify", title_zh: "未来工作:AI 不替代,而是放大", title_en: "Future of Work: AI does not replace, it amplifies",
    person_slug: "lex-fridman", duration_sec: 2460, topic_slugs: ["future-of-work"], platform: "youtube", platform_id: "lf001" },
  { slug: "constitutional-ai-explained", title_zh: "Constitutional AI 是什么", title_en: "What is Constitutional AI",
    person_slug: "dario-amodei", duration_sec: 1920, topic_slugs: ["ai"], platform: "youtube", platform_id: "da002" },
  { slug: "anthropic-business-logic", title_zh: "Anthropic 的商业逻辑", title_en: "The business logic of Anthropic",
    person_slug: "dario-amodei", duration_sec: 3480, topic_slugs: ["startup"], platform: "youtube", platform_id: "da003" },
  ...
  { slug: "sam-agent-commercialization", title_zh: "Sam Altman 谈 agent 商业化", title_en: "Sam Altman on agent commercialization",
    person_slug: "sam-altman", duration_sec: 3900, topic_slugs: ["ai", "ai-agent"], platform: "youtube", platform_id: "sa002" },
  { slug: "multi-agent-engineering", title_zh: "Multi-agent 系统的真实工程挑战", title_en: "Real engineering challenges of multi-agent systems",
    person_slug: "andrej-karpathy", duration_sec: 2880, topic_slugs: ["ai-agent"], platform: "youtube", platform_id: "kp002" },
  { slug: "demis-game-to-science", title_zh: "Demis:从游戏到科学", title_en: "Demis: From games to science",
    person_slug: "demis-hassabis", duration_sec: 4080, topic_slugs: ["ai"], platform: "youtube", platform_id: "dh002" },
  ...
  { slug: "jensen-cuda-moat", title_zh: "Jensen:CUDA 是真正的护城河", title_en: "Jensen: CUDA is the real moat",
    person_slug: "jensen-huang", duration_sec: 3000, topic_slugs: ["chip"], platform: "youtube", platform_id: "jh002" },
  { slug: "marc-software-eating", title_zh: "Marc:软件依然在吃世界", title_en: "Marc: Software is still eating the world",
    person_slug: "marc-andreessen", duration_sec: 3300, topic_slugs: ["startup"], platform: "youtube", platform_id: "ma001" },
  ...
  { slug: "agent-tools-memory", title_zh: "工具 + 记忆:Agent 的两条腿", title_en: "Tools + memory: the two legs of an agent",
    person_slug: "andrej-karpathy", duration_sec: 2520, topic_slugs: ["ai-agent"], platform: "youtube", platform_id: "kp003" },
  ...
  { slug: "demis-protein-folding-frontier", title_zh: "Demis:蛋白质折叠的下一站", title_en: "Demis: the next frontier of protein folding",
    person_slug: "demis-hassabis", duration_sec: 3060, topic_slugs: ["ai"], platform: "youtube", platform_id: "dh003" },
  { slug: "marc-techno-optimism", title_zh: "Marc:技术乐观主义宣言", title_en: "Marc: a techno-optimist manifesto",
    person_slug: "marc-andreessen", duration_sec: 3960, topic_slugs: ["future-of-work"], platform: "youtube", platform_id: "ma002" },
